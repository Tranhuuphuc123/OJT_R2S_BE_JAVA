...
//class product: lam mau dai dien cac doi tuong san pham
public class Product {
    private int productID;
    private String name;
    private double price;
    private int quantityInStock; // so luong ton kho
    ...
    public Product(int productID, String name, double price, int quantityInStock) {
        ...
        this.name = name;
        this.price = price;
        this.quantityInStock = quantityInStock; // so lg ton kho
    }
